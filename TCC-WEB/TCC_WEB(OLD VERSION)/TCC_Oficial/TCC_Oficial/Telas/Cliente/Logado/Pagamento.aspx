        ...
        <tr>
            ...
            <td>
                <fieldset id="gpboxEsqueceu1" style="border-color: Red; border-width:2px;">
                    ...
                    <br />
                    <asp:Button ID="btnAvancarTela" CssClass="btAvancarTela" Font-Bold="true" Font-Names="Quicksand" runat="server" Text="Finalizar Compra" OnClick="btnAvancarTela_Click" Width="254px" /><br />
                </fieldset>
            </td>
