...
DROP TABLE TB_DETALHE_CONTA;
CREATE TABLE TB_DETALHE_CONTA (
ID_DETALHE INTEGER,
ID_CONTAS INTEGER,
ID_FORMA_PAGAMENTO INTEGER,
VALOR NUMBER(24,2),

CONSTRAINT DETALHE_CONTA_PK PRIMARY KEY(ID_DETALHE),
CONSTRAINT DETALHE_CONTA_FK FOREIGN KEY(ID_CONTAS)
REFERENCES TB_CONTAS(ID_CONTAS),
CONSTRAINT DETALHE_FORMA_PAG_FK FOREIGN KEY(ID_FORMA_PAGAMENTO)
REFERENCES TB_FORMA_PAGAMENTO(ID_FORMA_PAGAMENTO)
);

DROP TABLE TB_DETALHE_CONTA_VENDA;
CREATE TABLE TB_DETALHE_CONTA_VENDA(
ID_DETALHE_VENDA INTEGER,
ID_CONTAS INTEGER,
ID_VENDA INTEGER,

CONSTRAINT DETALHE_CONTA_VENDA_PK PRIMARY KEY(ID_DETALHE_VENDA),
CONSTRAINT DETALHE_CV_CONTA_FK FOREIGN KEY(ID_CONTAS)
REFERENCES TB_CONTAS(ID_CONTAS),
CONSTRAINT DETALHE_CV_VENDA_FK FOREIGN KEY(ID_VENDA)
REFERENCES TB_VENDA_INGRESSO(ID_VENDA)
...
DROP TABLE TB_CANCELA_VENDA;
CREATE TABLE TB_CANCELA_VENDA(
ID_CANCELA_VENDA INTEGER NOT NULL,
ID_VENDA INTEGER NOT NULL,
MOTIVO VARCHAR2(20),
DATA_CANCELAMENTO DATE,
ID_FUNC INTEGER NOT NULL,

CONSTRAINT TB_CANCELA_VENDA_PK PRIMARY KEY (ID_CANCELA_VENDA),
CONSTRAINT TB_CANCELA_VENDA_FK FOREIGN KEY (ID_VENDA)
    REFERENCES TB_VENDA_INGRESSO(ID_VENDA),
 CONSTRAINT TB_CANCELA_FUNC_FK FOREIGN KEY (ID_FUNC)
...
CREATE TABLE TB_PAGAMENTO(
    ID_PAGAMENTO_GERAL INTEGER NOT NULL,
    ID_PAGAMENTO INTEGER NOT NULL,
    ID_FORMA_PAGAMENTO INTEGER,
    QUANTIA NUMBER(10,2),
    
    CONSTRAINT TB_PAGAMENTO_PK PRIMARY KEY (ID_PAGAMENTO_GERAL,ID_PAGAMENTO),
    CONSTRAINT TB_PAGAMENTO_FK FOREIGN KEY(ID_FORMA_PAGAMENTO) REFERENCES 
...
DROP TABLE TB_DESCONTOS_CLIENTE;
...
CONSTRAINT TB_FUNC_LOG_FK FOREIGN KEY (ID_FUNC)
    REFERENCES TB_FUNCIONARIO(ID_FUNC)
);
DROP TABLE TB_TABELAS_LOG;
...
ALTER TABLE TB_LOG_EXCLUSAO ADD DESCRICAO VARCHAR2(50);
DROP TABLE TB_LOG_EXCLUSAO
