<%@ Page Title="Ajuda" Language="C#" MasterPageFile="~/ModeloOff.Master" AutoEventWireup="true" CodeBehind="AjudaOff.aspx.cs" Inherits="Boots.SemLogin.AjudaOff" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <div class="container" id="cont2">
        <p>Mande-nos um email, ligue para nós ou contate-nos via WhatsApp:</p>
