<%@ Page Title="Humoristas" Language="C#" MasterPageFile="~/ModeloOff.Master" AutoEventWireup="true" CodeBehind="ArtistasOff.aspx.cs" Inherits="Boots.SemLogin.ArtistasOff" %>
            ...
            <ContentTemplate>
                ...
                <div class="container" style="text-align: center">
                    ...
                    <asp:DropDownList ID="cbFiltro" Height="30px" Font-Names="Quicksand" runat="server" Font-Size="Larger">
                        ...
                        &nbsp;
                    <asp:ImageButton runat="server" OnClick="btnPesquisar_Click" ID="btnPesquisar" Style="background-color: lightgrey; height: 30px; border-radius:9px;" ImageUrl="~/img/ProcurarIcone.png"></asp:ImageButton>
                    </div>
                    <br />
